...
#############################
# 데이터 입력
workers <- c(0, 1, 2, 3, 4, 5, 6)
output  <- c(0, 50, 90, 120, 140, 150, 155)
...
plot(workers, output, 
     ...
     cex.main = 2,      # 제목 글씨 크기
     cex.lab = 2,     # 축 제목 글씨 크기
     cex.axis = 2)     # 축 눈금 글씨 크기)
...
#############################
# 데이터 입력
workers <- c(0, 50, 90, 120, 140, 150, 155)
output  <- c(30, 40, 50, 60, 70, 80, 90)
...
#         cex.main = 2)
# 
# axis(1, at = 1:10, cex.axis = 2)
# axis(2, at=seq(0, 3.50, by=0.25), labels=seq(0, 3.50, by=0.25), cex.axis=2, las = 1)
# 
# grid()
# legend("topright", legend = c("AFC","AVC","ATC","MC"),
#        col = 1:4, pch = 20, lty = 1, bty = "n")
